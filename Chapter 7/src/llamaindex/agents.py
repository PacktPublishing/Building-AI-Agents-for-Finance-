...
profitability_agent = FunctionAgent(
    ...
    system_prompt=(
        ...
        "comment on these ratios based on the threshold values provided "
        "in threshold_profitability_comments. DO NOT ADD anything else.\n"
...
liquidity_agent = FunctionAgent(
    ...
    system_prompt=(
        ...
        "comment on these ratios based on the threshold values provided "
        "in threshold_liquidity_comments. DO NOT ADD anything else.\n"
        "Once the comments are done, you should hand off control to the "
        "SupervisorAgent.\n"
    ),
    llm=llm,
...
supervisor_agent = FunctionAgent(
    ...
    system_prompt=(
        ...
        "and LiquidityAgent.\n"
        "Call get_overall_comments exactly once. Then, based on the "
        "results in the comments coming from the ProfitabilityAgent "
        "and LiquidityAgent, provide an overall comment on the company.\n"
